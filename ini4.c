...
static char *_module_name="ini4.4gl";


A4GL_MAIN int main(int argc,char *argv[]);
#define fgldate long
static char const _rcsid[]="$FGLIdent: ini4.4gl Compiler-1.61  Log:Not Set $";
